...
<html lang="es"> <!-- HTML en español -->
    ...
    <link rel="stylesheet" href="assets/css/global.css"> <!-- Estilos globales -->
    <link rel="stylesheet" href="assets/css/style_index.css"> <!-- Estilos específicos para la página de inicio -->
    <link rel="stylesheet" href="assets/css/includes.css"> <!-- Estilos para elementos incluidos -->
        ...
        <section id="seccion-principal"> <!-- Sección principal del gestor de partidas -->
            ...
            <div id="panel-control">
                ...
                <a id="btn-fondo-ver" class="btn-fondo" 
                   href="<?php echo isset($_SESSION['ID_Usuarios']) ? 'ver_partida.php' : 'src/login.php?redirect=' . urlencode('/ver_partida.php'); ?>" 
                ...
                <a id="btn-fondo-crear" class="btn-fondo" 
                   href="<?php 
                       if (!isset($_SESSION['ID_Usuarios'])) {
                           echo 'src/login.php?redirect=' . urlencode('/crear_partida.php');
                ...
                <a id="btn-fondo-editar" class="btn-fondo" 
                   href="<?php 
                       if (!isset($_SESSION['ID_Usuarios'])) {
                           echo 'src/login.php?redirect=' . urlencode('/editar_partida.php');
                       } elseif ($_SESSION['Tipo_Usr'] === 'Adm' || $_SESSION['Tipo_Usr'] === 'Mod') {
