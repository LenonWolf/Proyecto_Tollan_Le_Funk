        ...
        methods: {
            ...
            async guardarCambios() {
                ...
                try {
                    ...
                    const response = await fetch('/src/procesar_edicion_usuario.php', {
                        method: 'POST',
                        body: formData
                    });
            ...
            async cambiarPassword() {
                ...
                try {
                    ...
                    const response = await fetch('/src/procesar_cambio_password.php', {
                        method: 'POST',
                        body: formData
                    });
            ...
            async eliminarCuenta() {
                ...
                try {
                    ...
                    const response = await fetch('/src/procesar_eliminacion_usuario.php', {
                        method: 'POST',
                        body: formData
                    });
